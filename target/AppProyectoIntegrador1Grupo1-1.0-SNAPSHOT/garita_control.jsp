...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>TRANSVISA - Rol: Operador de Garita</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    </head>
    <body class="bg-light">
        <nav class="navbar navbar-dark bg-secondary shadow-sm py-3">
            <div class="container-fluid px-4">
                <a class="navbar-brand fw-bold" href="#">TRANSVISA E.I.R.L. - Portal Control de Accesos</a>
                <span class="navbar-text text-white">Garita: <strong><%= session.getAttribute("usuarioLogueado")%></strong></span>
                <a href="../login" class="btn btn-sm btn-outline-light">Cerrar Sesión</a>
            </div>
        </nav>
        <div class="container py-5">
            <div class="card p-5 shadow-sm border-0">
                <h2 class="text-secondary fw-bold">🚪 Registro de Entradas y Salidas (Garita)</h2>
