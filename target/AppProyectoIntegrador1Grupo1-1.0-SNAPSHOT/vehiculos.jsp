                        ...
                        <% 
                            ...
                            if (lista != null) {
                                for (Vehiculo v : lista) {
                                    ...
                                    if ("En Taller".equals(v.getEstadoOperativo())) badgeColor = "bg-warning text-dark";
                                    if ("En Ruta".equals(v.getEstadoOperativo())) badgeColor = "bg-info text-dark";
                                    if ("Inactivo".equals(v.getEstadoOperativo())) badgeColor = "bg-danger";
                        %>
                        <tr>
