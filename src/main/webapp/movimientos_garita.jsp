<%-- 
    Document   : movimientos_garita
    Created on : 25 jun. 2026, 22:28:15
    Author     : luis.azanero
--%>
...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>TRANSVISA - Control de Garita</title>
    ...
    <body class="bg-light">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
            <div class="container-fluid px-4">
                ...
                <div class="navbar-nav me-auto">
                    ...
                    <a class="nav-link active" href="garita">Control Garita</a>
                </div>
                <span class="navbar-text text-white">
                    Operador Garita: <strong><%= session.getAttribute("usuarioLogueado")%></strong>
                </span>
            </div>
        </nav>
        ...
        <div class="container-fluid px-4 py-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-secondary fw-bold mb-0">Registro de Entradas y Salidas de Flota</h2>
                <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modalMovimiento" onclick="prepararFormulario()">
                            ...
                            <%
                                ...
                                if (lista != null) {
                                    for (MovimientoGarita m : lista) {
                                        String opBadge = "ENTRADA".equals(m.getTipoOperacion()) ? "badge bg-success p-2" : "badge bg-danger p-2";
                            %>
                            <tr>
        ...
        <div class="modal fade" id="modalMovimiento" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="garita" method="POST">
                        <div class="modal-header bg-dark text-white">
                            <h5 class="modal-title">Generar Ticket de Control Perimetral</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-4 border p-2 rounded bg-white">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label text-danger fw-bold" for="opSalida">📦 SALIDA (Despacho a Ruta)</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipoOperacion" id="opEntrada" value="ENTRADA">
                                        <label class="form-check-label text-success fw-bold" for="opEntrada">🏭 ENTRADA (Retorno a Base)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" name="kilometrajeRegistro" id="formKm" class="form-control" placeholder="Ej: 14520.50" required>
                                <div class="form-text text-muted">⚠️ El kilometraje ingresado actualizará el odómetro maestro del vehículo.</div>
                            </div>
                        </div>
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" class="btn btn-dark">Confirmar Movimiento</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function () {
                $('#tablaMovimientos').DataTable({
                    responsive: true,
                    order: [[0, "desc"]], // Ordenar por ID de ticket (más reciente primero)
                    language: {
